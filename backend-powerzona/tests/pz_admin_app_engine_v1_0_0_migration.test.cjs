...
test('motor 2.0.0 comparte nombre, versión, contrato y Firebase obligatorio', () => {
  assert.deepEqual(engine, {
    name: 'Tu Senda 84 Admin Engine',
    version: '2.0.0',
    contract_version: 2,
    firebase_required: true,
    api_base_url: 'https://api.tusenda84.com',
  });
  assert.deepEqual(backend.engineDescriptor({ version: '2.0.0', revision: 'a'.repeat(40) }), {
    ...engine,
