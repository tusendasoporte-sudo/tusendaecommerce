...
test('motor 1.0.0 comparte nombre, versión y contrato entre manifiesto y backend', () => {
  assert.deepEqual(engine, { name: 'Tu Senda 84 Admin Engine', version: '1.0.0', contract_version: 1 });
