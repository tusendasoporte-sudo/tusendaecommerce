...
test('dimensiones se derivan de la revisión publicada y Landing QR falla cerrado', () => {
...
test('DATA admite landing_qr_open sin sección/acción y conserva tenant/revisión estrictos', () => {
