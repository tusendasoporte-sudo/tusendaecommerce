...
const SYSTEM_CATALOGS = Object.freeze({
  "promo.system.v1": Object.freeze({
    en: catalog("English", "ltr", {
      ...
      "a11y.landing_qr_link": "Open {business}'s link page",
    ...
    es: catalog("Español", "ltr", {
      ...
      "reviews.unavailable": "Las reseñas no están disponibles en este momento",
