...
const ACTION_CATALOG = Object.freeze({
  ...
  "promo.reviews.request.reveal": definition("reviews", "important", ["promo_review_request"], "Recuperó un enlace privado de reseña", { allowEmptyPaths: true }),
  "promo.reviews.request.revoke": definition("reviews", "important", ["promo_review_request"], "Revocó una solicitud privada de reseña"),
  "promo.reviews.request.delete": definition("reviews", "critical", ["promo_review_request"], "Eliminó definitivamente una solicitud privada de reseña", { allowEmptyPaths: true }),
