...
const PUBLIC_CREATE_RULE = '@request.auth.id = "" && @request.body.store != ""';
...
migrate((app) => {
  ...
  collection.createRule = `(${PUBLIC_CREATE_RULE}) || (${MASTER_ADMIN_RULE}) || (${STORE_USER_CREATE_RULE})`;
  collection.listRule = `(${MASTER_ADMIN_RULE}) || (${STORE_USER_RECORD_RULE})`;
  collection.viewRule = `(${MASTER_ADMIN_RULE}) || (${STORE_USER_RECORD_RULE})`;
  collection.updateRule = `(${MASTER_ADMIN_RULE}) || (${STORE_USER_RECORD_RULE})`;
  ...
  collection.createRule = `(${MASTER_ADMIN_RULE}) || (${STORE_USER_CREATE_RULE})`;
  collection.listRule = `(${MASTER_ADMIN_RULE}) || (${STORE_USER_RECORD_RULE})`;
  collection.viewRule = `(${MASTER_ADMIN_RULE}) || (${STORE_USER_RECORD_RULE})`;
  collection.updateRule = `(${MASTER_ADMIN_RULE}) || (${STORE_USER_RECORD_RULE})`;
  collection.deleteRule = MASTER_ADMIN_RULE;
