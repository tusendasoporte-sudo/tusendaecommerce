...
const ENGLISH_COPY: Readonly<Record<string, string>> = Object.freeze({
  ...
  'Portada, galerías y trabajos': 'Cover, galleries, and projects',
  ...
  'Cargando página y biblioteca…': 'Loading page and library…',
  'Portada': 'Cover',
  ...
  '+ Crear otra galería': '+ Create another gallery',
  'Biblioteca privada de la tienda': 'Private store library',
