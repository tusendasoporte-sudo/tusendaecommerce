...
const ENGLISH_COPY: Readonly<Record<string, string>> = Object.freeze({
  ...
  'Administra la portada, la foto de cada servicio, sus productos o trabajos y hasta tres videos para toda la página Promo.': 'Manage the cover, each service photo, its products or projects, and up to three videos for the entire Promo page.',
  'Videos': 'Videos',
  'Puedes publicar entre 0 y 3 videos en toda la página. Cada video requiere una imagen de portada.': 'You can publish between 0 and 3 videos on the entire page. Each video requires a cover image.',
  '+ Añadir video': '+ Add video',
  'Título del video': 'Video title',
  'Subir video': 'Upload video',
  'Eliminar video': 'Delete video',
  'Todavía no hay videos en la página.': 'There are no videos on the page yet.',
  'El plan actual no incluye videos.': 'The current plan does not include videos.',
  ...
  'Portada visual, fotos de servicios, ofertas, productos y videos.': 'Visual cover, service photos, offers, products, and videos.',
  ...
  'Puente explícito a la Landing QR cuando el plan lo permite.': 'Explicit link to the QR Landing when the plan allows it.',
  ...
  'Título de videos': 'Video section title',
  'Resumen de videos': 'Video section summary',
  'Videos de la página': 'Page videos',
  ...
  'Guardado directo · CAS': 'Direct save · CAS',
  ...
  'Guardado directo · página pública': 'Direct save · public page',
  'Imágenes almacenadas': 'Stored images',
  'Medios usados en la página': 'Media used on the page',
  ...
  'Una imagen crea una portada fija; varias imágenes o videos crean un carrusel accesible.': 'One image creates a fixed cover; multiple images or videos create an accessible carousel.',
  'Agregar imágenes': 'Add images',
  'Video MP4/WebM': 'MP4/WebM video',
  'Poster del video': 'Video poster',
  'Añadir video': 'Add video',
  'Guardar contenido visual': 'Save visual content',
  'Propietario': 'Owner',
  ...
  'Publica fotos del resultado o videos mientras realizas un trabajo. Cada trabajo admite hasta 3 medios y la tienda conserva un máximo global de 3 videos.': 'Publish result photos or videos while completing a project. Each project accepts up to 3 media items, and the store keeps a global maximum of 3 videos.',
  'Trabajos': 'Projects',
  ...
  'Añade fotos del resultado o un video del trabajo.': 'Add result photos or a project video.',
  'Puede incluir hasta 3 fotos o videos y marcarse como destacado.': 'It can include up to 3 photos or videos and be marked as featured.',
  ...
  'Videos almacenados': 'Stored videos',
  ...
  'Vigencia': 'Validity',
  'Fotos del trabajo (opcional, máximo 3)': 'Job photos (optional, maximum 3)',
  'Se convierten a WebP, sin metadatos ni nombre original.': 'They are converted to WebP without metadata or original filename.',
  ...
  'Anterior': 'Previous',
  'Siguiente': 'Next',
  'Puente de solo acceso': 'Access-only bridge',
  'Landing QR existente': 'Existing QR Landing',
  'Página Promo': 'Promo page',
  'Enlace público': 'Public link',
  'Mostrar acceso a Landing QR': 'Show QR Landing access',
});
