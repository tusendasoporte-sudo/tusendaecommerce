...
export const PROMO_ADMIN_MODULES = Object.freeze([
  Object.freeze({
    ...
    description: 'Identidad, secciones, servicios y pie del sitio.',
    actions: Object.freeze(['promo.content.manage'] as PromoActionKey[]),
    delivery: 'El editor de contenido se habilitará en la siguiente etapa aprobada.',
  }),
  Object.freeze({
    section: 'gallery',
    label: 'Galería y medios',
    shortLabel: 'Galería',
    description: 'Imágenes, trabajos destacados y recursos audiovisuales.',
    actions: Object.freeze(['promo.media.manage'] as PromoActionKey[]),
    delivery: 'La gestión de galería y medios se habilitará en su etapa específica.',
  }),
  Object.freeze({
    section: 'appearance',
    label: 'Apariencia',
