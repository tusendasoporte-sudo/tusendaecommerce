...
- Mantener exclusivamente C08 `EN CURSO`. Las correcciones y la retención de siete días ya están publicadas y desplegadas en frontend/PocketBase staging. Falta comprobar la eliminación automática con un registro realmente vencido, completar los casos manuales C08 aún abiertos —especialmente colaborador sin permiso, móvil mutable, confirmaciones/errores y accesibilidad humana— y cerrar solo C08 cuando exista evidencia suficiente. No iniciar C09.
